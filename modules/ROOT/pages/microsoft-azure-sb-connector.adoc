...
When designing your application in Studio, dragging the connector from the *Mule Palette* onto the Anypoint Studio canvas automatically populates the XML code with the connector namespace and schema location.
...
If you are manually coding the Mule application in Studio’s XML editor or other text editor, paste these into the header of your Configuration XML, inside the <mule> tag, as shown below:
