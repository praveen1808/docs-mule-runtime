...
If you manually code a Mule app in XML either from the Anypoint Studio XML editor or from a text editor, you can get access to the Microsoft Azure Service Bus connector in your app by adding reference statements to your XML Mule flow and in the Apache Maven `pom.xml` file.

[NOTE]
====
You can avoid the manual process described in this topic by using Studio. When you install the Microsoft Azure Service Bus connector in Anypoint Studio, Studio automatically populates the XML code with the Microsoft Azure Service ıus namespace and schema location, and adds a dependency to the `pom.xml` file.
====
...
hhttp://www.mulesoft.org/schema/mule/microsoft-azure-service-bus/current/mule-microsoft-azure-service-bus.xsd
----
...
<dependency>
  ...
  <artifactId>mule-module-microsoft-azure-servicebus</artifactId>
